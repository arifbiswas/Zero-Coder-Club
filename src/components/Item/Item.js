...
const Item = ({item}) => {
    ...
    return (
        <div className='w-96 h-[550px] border p-3 shadow-lg relative rounded-xl'>
            ...
            <button className='btn bg-[#5d5fef] px-32 py-4 text-white text-1xl absolute bottom-5  right-5 rounded-2xl'>Add To List</button>
