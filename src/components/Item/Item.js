...
const Item = ({item ,timeHabdler}) => {
    ...
    return (
        <div className='w-96 h-[550px] border p-3 mx-1 shadow-lg relative rounded-xl bg-white'>
            ...
            <button onClick={()=>timeHabdler(id)} className='btn bg-[#5d5fef] px-28 py-4 text-white text-1xl absolute bottom-5  right-7 rounded-2xl'><FontAwesomeIcon icon={faAdd}></FontAwesomeIcon> Add To List</button>
