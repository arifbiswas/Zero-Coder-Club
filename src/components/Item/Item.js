...
const Item = ({item ,timeHabdler}) => {
    ...
    return (
        <div className='w-80 h-[500px] border  mx-1 shadow-lg relative rounded-xl bg-white hover:outline outline-[#5d5fef]'>
            ...
            <button onClick={()=>timeHabdler(id)} className='btn bg-[#5d5fef] hover:text-[#5d5fef] hover:bg-white font-bold px-20 lg:px-20 py-4 hover:outline text-white text-1xl absolute bottom-0 w-full  rounded-b-2xl'><FontAwesomeIcon icon={faAdd}></FontAwesomeIcon> Add To List</button>
